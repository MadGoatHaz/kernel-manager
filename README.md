...
[![AUR version](https://img.shields.io/aur/version/kernel-manager.svg?label=kernel-manager)](https://aur.archlinux.org/packages/kernel-manager)
[![AUR version](https://img.shields.io/aur/version/kernel-manager-bin.svg?label=kernel-manager-bin)](https://aur.archlinux.org/packages/kernel-manager-bin)
